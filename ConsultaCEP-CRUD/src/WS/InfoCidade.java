...
{
    private String codigo_ibge; //atributo - fora do padrao de nomenclatura (o correto é juntar, mas é para seguir a nomenclatura do Json)
    //getter de codigo_ibge
    public  String getCodigo_ibge()
    {
        return this.codigo_ibge;
    }
    //setter de codigo_ibge
    ...
    private String area_km2;//mesma coisa do atributo anterior
    ...
    //construtor
    public InfoCidade (String codigoIBGE, String areaEmKm2) throws Exception //pega os dados de todos os atributos
    {
        //usa os setters para atribuir os dados passados como parametros
        this.setCodigo_ibge (codigoIBGE);
        this.setArea_km2    (areaEmKm2);
    }

    // exigencia do mapeador de JSon - JSon vai ser transformado em um objeto dessa classe
    //construtor sem parametros e sem comandos
    public InfoCidade () {}
    ...
    public boolean equals (Object obj)
    {
        ...
        //if (!(obj.getClass != WS.InfoCidade.class))
    ...
    //construtor de cópia - também obrigatório
